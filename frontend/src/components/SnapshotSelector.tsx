...
const SnapshotSelector: React.FC<SnapshotSelectorProps> = ({
     ...
     return (
          <div
               className="modal-backdrop-mobile md:modal-desktop fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 modal-enter"
               onClick={handleBackdropClick}
          >
               {/* Main Modal */}
               {!selectedSnapshot && (
                    <div className="modal-mobile md:modal-content-desktop bg-dark-surface border border-dark-border rounded-lg w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col modal-content-mobile">
                         {/* Header */}
                         <div className="modal-header flex items-center justify-between p-6 border-b border-dark-border">
                              <div>
               ...
               {/* Preview Modal */}
               {selectedSnapshot && (
                    <div className="modal-mobile md:modal-content-desktop bg-dark-surface border border-dark-border rounded-lg w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col modal-content-mobile">
                         {/* Header */}
                         <div className="modal-header flex items-center justify-between p-6 border-b border-dark-border">
                              <div className="flex-1">
                                   <h2 className="text-xl font-semibold text-dark-text">
                         ...
                         {/* Footer Actions */}
                         <div className="modal-footer flex items-center justify-between p-6 border-t border-dark-border">
                              <button
