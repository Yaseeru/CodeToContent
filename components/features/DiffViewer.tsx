...
export function DiffViewer({ diff, fileName = "No file selected" }: DiffViewerProps) {
    ...
    if (!diff || diff.length === 0) {
        return (
            <Card className="bg-background-secondary border-none overflow-hidden">
                ...
                <div className="p-8 text-center text-foreground-secondary">
                    <FileText size="lg" className="mx-auto mb-4 text-foreground-secondary" />
        ...
        <Card className="bg-background-secondary border-none overflow-hidden">
            ...
            <div className="p-0 overflow-x-auto">
                {diff.map((line, idx) => (
                    ...
                    >
                        <div className="w-[48px] flex-shrink-0 text-right pr-4 select-none text-diff-line-number bg-black/10">
                            {line.lineNo}
                        </div>
                        <div className={cn(
                            "pl-4 whitespace-pre",
